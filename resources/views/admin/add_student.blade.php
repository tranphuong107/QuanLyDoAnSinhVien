...
">
        ...
        <div class="main">
            ...
            <div class="p-3 pt-0">
                <div class="container bg-light p-0 m-0" style="max-height:650px;border-radius:5px;box-shadow: 0px 0.1875rem 0.4375rem rgb(0 0 0 / 25%);">
                    <a href="{{ URL::to('/student-list') }}" class="btn_back" style="position: absolute;">
