...
<html lang="en">
    ...
    <head>
        ...
        <title>Trang chủ | Đổi mật khẩu</title>
...
">
        ...
        <div class="main">
            ...
            <div style="padding:0 15rem;margin:5rem 0">
                <div class="container bg-light" style="max-height:650px;box-shadow: 0px 0.1875rem 0.4375rem rgb(0 0 0 / 25%);">

                    <h5 class="text-dark mt-2 fs-3" style="text-align:center">Đổi mật khẩu</h5>
                    ...
                    @endif
                    <form action="{{ URL::to('/change_password', ['ID' => $data->ID]) }}" method="post">
                        @csrf

                        <div class="p-3">
                            <div class="mb-3">
                                <label for="floatingInput">Mật khẩu hiện tại</label>
                                <input type="password" class="form-control" id="floatingInput" name="pass_old"
                                    style="background-color:#D9D9D9">

                            </div>
                            <div class=" mb-3">
                                <label for="floatingInput">Mật khẩu mới</label>
                                <input type="password" class="form-control" id="floatingInput" name="pass_new"
                                    style="background-color:#D9D9D9">

                            </div>
                            <div class=" mb-3">
                                <label for="floatingInput">Nhập lại mật khẩu mới</label>
                                <input type="password" class="form-control" id="floatingInput" name="pass_new_check"
                                    style="background-color:#D9D9D9">

                            </div>
                        </div>
                        <div class="btn mb-2" style="position: relative; left:42%">
