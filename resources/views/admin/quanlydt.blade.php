                    ...
                    <div class="content-profile">
                        ...
                        <div class="box-info" style="margin-top:.7rem">
                            <h5 onclick="popup()" style="font-size: 16px;" class="pt-2 pb-2"><i
                                    class="fa-solid fa-power-off"></i> Đóng tài khoản</h5>
                        </div>
                    </div>
    ...
    <div class="main">
        ...
        <div class="p-3" style="font-size:22px">
            <div class="container bg-light" style="max-height:620px;border-radius:5px;box-shadow: 0px 0.1875rem 0.4375rem rgb(0 0 0 / 25%);">
                <h5 class="mt-4" style="text-align:center;font-size:22px;margin:2.5rem 0">DANH SÁCH ĐỀ TÀI SINH VIÊN</h5>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $stu)
                                    <tr>
                                        ...
                                        <td style="text-align:left">{{ $stu->Title }}</td>
                                        <td><a href="{{ URL::to('quanlydt_phancong/' . $stu->ID) }}"
                                                style="font-size: 16px;cursor: pointer;text-decoration:none;font-size:20px">Phân
                                                công</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
