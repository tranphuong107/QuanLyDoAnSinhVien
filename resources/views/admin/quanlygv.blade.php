...
">
                        ...
                        <form action="">
                            <div class="">
                                ...
                                <div class="btn_add" style="float: right;">
                                    <a href="{{ URL::to('/add_lecturers') }}" class="btn mt-2"
                                        style="background-color:#D9D9D9;border-radius:5px;font-size:20px"><i
                                            class="fa-solid fa-user-plus me-1"></i>Thêm giảng viên</a>
                                </div>
                            </div>
                            @if($datagv->isEmpty())
                            <div class="error" id="error">
                                <p style="margin-top:1rem">Danh sách giảng viên trống</p>
                            </div>
                            @else
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datagv as $gv)
                                        <tr>
                                            <td>{{ $count++ }}</td>
                                            <td>{{ $gv->FullName }}</td>
                                            <td>{{ $gv->LecturerCode }}</td>
                                            <td>{{ $gv->DepartmentName }}</td>
                                            <td>
                                                <a href="{{ URL::to('update-lecturer/' . $gv->ID) }}"
                                                    class="btn btn-success me-2"><i class="fa-solid fa-gear"
                                                        style="font-size:14px"></i>
                                                    Sửa</a>
                                                    <a onclick="popupDelete('{{ $gv->ID }}')"
        ...
        <script>
            ...
            function popupDelete(ID) {
                var url = "{{ URL::to('delete-lecturer') }}/" + ID;
