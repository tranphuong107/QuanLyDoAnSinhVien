...
">
        ...
        <div class="main">
            ...
            <div class="p-3" style="font-size:22px">
                <div class="container bg-light"
                    ...
                    <h5 class="mt-2" style="text-align:center;font-size:22px">DANH SÁCH SINH VIÊN</h5>
                        ...
                        <form action="">
                            <div class="">
                                ...
                                <div class="btn_add" style="float: right;">
                                    <a href="{{ URL::to('/add_student') }}" class="btn mt-2"
                                        style="background-color:#D9D9D9;border-radius:5px;font-size:20px"><i
                                            class="fa-solid fa-user-plus me-1"></i>Thêm sinh viên</a>
                                </div>
                            </div>
                            @if($data->isEmpty())
                            <div class="error" id="error">
                                <p style="margin-top:1rem">Danh sách sinh viên trống</p>
                            </div>
                            @else
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $stu)
                                        <tr>
                                            ...
                                            <td>{{ $stu->ClassName }}</td>
                                            <td>
                                                <a href="{{ URL::to('update-student/' . $stu->ID) }}"
                                                    class="btn btn-success me-2"><i class="fa-solid fa-gear"
                                                        style="font-size:14px"></i>
                                                    Sửa</a>
                                                    <a onclick="popupDelete('{{ $stu->ID }}')"
                                    ...
                                    <div>
                                        <span aria-current="page">
                                            @php
                                                $stt = 1;
                                            @endphp
                                            <a href="http://localhost/Laravel10copy/public/lecturers-list?page=1"
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
                                                aria-label="Go to page 1">{{ $stt++ }}
                                            </a>
                                            <a href="http://localhost/Laravel10copy/public/lecturers-list?page=2"
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
        ...
        <script>
            ...
            function popupDelete(ID) {
                var url = "{{ URL::to('delete-student') }}/" + ID;
