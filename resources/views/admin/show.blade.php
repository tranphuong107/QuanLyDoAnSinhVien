                ...
                <ul class="nav navbar-nav pull-right"
                    ...
                    <li class="dropdown dropdown-user mt-1">
                        <a style="font-size: 16px;color:#c6cfda;text-decoration:none" href="#" class=" me-3">
                            <img class="me-2" alt="" src="{{ asset('images/profile.png') }}"
        ...
        <div class="sidebar">
            ...
            <ul style="list-style: none;">
                <li data-href="{{ URL::to('/hoidong-list') }}" class="actives">
                    <a class="text-light">
                        <i class="fa-solid fa-folder-open text-light" style="color:#b4bcc8"></i><span>Quản lý hội đồng
                            phản
                            biện</span>
                    </a>
                </li>
        ...
        <div class="main">
            ...
            <div class="p-3" style="font-size:22px">
                <div class="container bg-light"
                    ...
                    <h5 class="mt-2" style="text-align:center;font-size:22px">DANH SÁCH HỘI ĐỒNG
                        {{ $council->CouncilName }}</h5>
