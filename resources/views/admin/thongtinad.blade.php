@if(session()->has('Role_id') && session()->has('UserName') && session()->has('Password'))
    ...
    <head>
        ...
        <title>Trang chủ | Thông tin quản trị viên</title>
...
">
        ...
        <!-- header -->
         ...
         <div class="sidebar">
            ...
            <ul style="list-style: none;background-color:#36c6d3">
                <li data-href="{{ URL::to('/home_admin') }}">
                    <a class="text-light">
                        <i class="fa-solid fa-desktop text-light"></i><span> Trang chủ</span>
                    </a>
                </li>
            </ul>
        ...
        <div class="main">
            ...
            <div class="p-3">
                <div class="container bg-light p-0" style="max-height:650px;border-radius:5px;box-shadow: 0px 0.1875rem 0.4375rem rgb(0 0 0 / 25%);">
                    ...
                    <h5 class="text-dark mt-2" style="text-align:center">THÔNG TIN QUẢN TRỊ VIÊN</h5>
                    ...
                    <form action="{{ URL::to('/save-student') }}" method="post">
                        ...
                        <div class="row p-0 m-2">
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <img alt="" src="{{ asset('images/profile.png') }}" width="100%" height="85%"
                                    style="border-radius:50%;margin:1rem 0">
                                {{-- <i class="bi bi-camera-fill text-secondary" style="position: absolute;top:30rem;left:13rem;cursor: pointer;font-size:35px;color:#f7f7f7;"></i>
                       <input type="file" name="image" accept="image/*" onchange="showFile(event)" style="position: absolute;top:31rem;left:2rem;cursor: pointer;opacity:0"> --}}
                            </div>
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12 mt-3">
                                <div class="">
                                    <div class=" mb-3">
                                        ...
                                        <input type="date" class="form-control" id="floatingInput"
                                            value="{{ $data['DateOfBirth'] }}" readonly>
                                    </div>
                                </div>
                                {{-- <div class="">
                                    <div class=" mb-3">
                                ...
                                <div class="">
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" class="form-control" id="floatingInput"
                                            value="{{ $data['Identity'] }}" readonly>

                                    </div>
                                </div>
                                <div class="">
                                    <div class=" mb-3">
                                        <label for="floatingInput">Mã quản trị viên</label>
                                        <input type="text" class="form-control" id="floatingInput"
                                            value="{{ session()->get('ID') }}" readonly>
