...
">
            ...
            <div class="p-3 pt-0">
                <div class="container bg-light p-0" style="max-height:650px;border-radius:5px;box-shadow: 0px 0.1875rem 0.4375rem rgb(0 0 0 / 25%);">
                    <a class="btn_back" style="position: absolute;cursor: pointer;">
                        <i class="bi bi-arrow-left fs-3 ms-2 text-secondary" onclick="popupDelete()"></i>
                    </a>
                    ...
                    @endif
                    <form action="{{ URL::to('xuly_capnhat_lecturer', ['ID' => $data->ID]) }}" method="post">
                        @csrf

                        <div class="row p-0 m-2 gap-5">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <img id="file-preview" alt="" src="{{ $data['Image'] }}" width="100%" height="85%"
                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" id="floatingInput"
                                            value="{{ $data['FullName'] }}" name="name_gv">
                                    </div>
                                </div>
                                <div class="">
                                ...
                                <div class="">
                                    ...
                                    <select name="position" class="form-select"
                                        ...
                                        @foreach ($data->lecturer as $lecturer)
                                            <option value="{{ $lecturer->Position }}">{{ $lecturer->Position }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 mt-3">
                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" id="floatingInput"
                                            value="{{ $data->lecturer->pluck('LecturerCode')->implode(',') }}"
                                            name="magv">
                                    </div>
                                </div>
                                <div class="">
                                    ...
                                    <select name="degree" class="form-select"
                                        aria-label="Default select example">
                                        @foreach ($data->lecturer as $lecturer)
                                            <option value="{{ $lecturer->Degree }}">{{ $lecturer->Degree }}</option>
                                        @endforeach
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 mt-3">
                                ...
                                <div class="">
                                    ...
                                    <select name="department" class="form-select p-2 "
                                        aria-label="Default select example" value="hegd">
                                        <!-- @foreach ($data->lecturer as $lecturer)
                                            <option value="{{ $lecturer->department->ID }}">
                                                {{ $lecturer->department->DepartmentName }}</option>
                                        @endforeach -->
                                        @foreach (DB::table('departments')->pluck('DepartmentName', 'ID') as $id => $department)
                                            <option  {{ $lecturer->department->DepartmentName == $department ? "selected":"" }} value="{{ $id }}">{{ $department }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <button type="submit" class="btn btn-secondary mb-2 ps-5 pe-5 mb-3 mt-3"
                            style="text-align:center;position:relative;left:45%">Cập nhật</button>
        ...
        <div class="popupDelete" id="popupDelete">
            <div class="ps-5 pt-1 pb-1 pe-5">
                <h5>Thông tin giảng viên vừa chỉnh sửa sẽ không được lưu. Bạn có chắc muốn thoát?</h5>
                <a class="btn btn-secondary mt-3 me-2" href="{{ URL::to('lecturers-list') }}">Thoát</a>
