...
<div class="sidebar">
    ...
    <ul style="list-style: none;" class="pt-2 pb-2 mt-0 mb-0 {{set_active(['trangchu'])}} {{set_active(['home_sinhvien'])}} {{set_active(['thongtincanhan'])}} {{set_active(['doimatkhau'])}}">
        <a href="{{URL::to('/trangchu')}}" class="myList">
            <li>
    ...
    <ul style="list-style: none;" class=" pt-2 pb-2 mt-0 mb-0 {{set_active(['dangkydetai'])}}">
        <a href="{{URL::to('/dangkydetai')}}" class="myList">
            <li >
    ...
    <ul style="list-style: none;" class=" pt-2 pb-2 mt-0 mb-0 {{set_active(['ketquadangky'])}}">
        <a href="{{URL::to('/ketquadangky',session()->get('ID') )}})}}" class="myList">
            <li>
            <i class="bi bi-folder myIcon" ></i>
                <span>Kết quả đăng ký đề tài</span>
            </li>
        </a>
    </ul>
    <ul style="list-style: none;" class=" pt-2 pb-2 mt-0 mb-0 {{set_active(['quanlytiendo'])}} {{set_active(['xembaocao'])}}">
        <a href="{{URL::to('/quanlytiendo',session()->get('ID') )}}"class="myList">
            <li>
    ...
    <ul style="list-style: none;" class=" pt-2 pb-2 mt-0 mb-0 {{set_active(['tracuudiem'])}}">
        <a href="{{URL::to('/tracuudiem',session()->get('ID') )}}"class="myList" >
            <li>
            <i class="bi bi-search myIcon" ></i>
                <span>Tra cứu điểm</span>
            </li>
        </a>
    </ul>
    <ul style="list-style: none;" class=" pt-2 pb-2 mt-0 mb-0 {{set_active(['thongbao'])}} {{set_active(['thongbaochitiet'])}}">
        <a href="{{URL::to('/thongbao')}}" class="myList">
            <li>
