...
@section('content')
       ...
       <h5 style="text-align:center; color:#0071C6">THÔNG BÁO</h5>
               ...
               <div class="p-3 thongbao">
                @foreach ($announcements as $announcement)
                    <tr>
                        <a href="{{ URL::to('/thongbaochitiet',$announcement->ID) }}" style="color:#000;text-decoration:none">
                ...
                @endforeach
                   ...
                   <!-- <a href="{{URL::to('/thongbaochitiet')}}" style="color:#000;text-decoration:none">
                    <div class="thongbao-item">
